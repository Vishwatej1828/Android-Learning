...
public class MobileNetV2Classifier {

    private static final String TAG = "MobileNetV2Classifier";
    private static final int IMAGE_SIZE = 224; // MobileNetV2 input size
    private static final int NUM_CLASSES = 1000; // MobileNetV2 output classes
